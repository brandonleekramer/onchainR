...
#' my_block_hash = "0xb1fac2cb5074a4eda8296faebe3b5a3c10b48947dd9a738b2fdf859be0e1fbaf"
#'
#' eth_getTransactionByHash(my_block_hash, my_provider_url, my_api_key)
#'
eth_getTransactionByHash = function(block_hash, provider_url, api_key){
  request_output = httr2::request(
    ...
    httr2::req_body_raw(
      stringr::str_c('{"method":"eth_getTransactionByHash", 
                     "id":1,"jsonrpc":"2.0", "params":["',block_hash,'"]}')) %>% 
    httr2::req_perform() %>%
