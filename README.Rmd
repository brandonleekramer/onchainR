...
[`etherscanr`](https://github.com/dirkschumacher/etherscanr/tree/master) is an open archive package that offers an easy way to use the etherscan.io API to query information about the Ethereum network.  
